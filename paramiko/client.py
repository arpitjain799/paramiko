...
class SSHClient(ClosingContextManager):
    ...
    def connect(
        ...
        if auth_strategy is not None:
            # TODO: document how this is expected to be an instance that has
            # already been prepped with everything it generally needs (both
            # upfront and lazy data), sans transport
